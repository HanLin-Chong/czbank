...
(function (factory) {
    ...
    defaultPreviewTypes = ['image', 'pdf',];//here 允许预览哪些对象
    ...
    FileInput.prototype = {
        ...
        _ajaxSubmit: function (fnBefore, fnSuccess, fnComplete, fnError, previewId, index) {
            ...
            var hanlin_is_quality_users = $(".is_quality_users").is(":checked");
            if(hanlin_is_quality_users){//1是优质客户，0不是
            	self.formdata.append("is_quality_users","1");
            }else{
            	self.formdata.append("is_quality_users","0");
            }
        ...
        _uploadSingle: function (i, files, allFiles) {
            ...
            fnError = function (jqXHR, textStatus, errorThrown) {
                ...
                setTimeout(function () {
                    ...
                    self._showUploadError("服务器端错误", params);
                }, 100);
            };

...
public class SendMailText {
    //发件人地址
    public static String senderAddress = "1220347113@qq.com";
    //收件人地址
    public static String recipientAddress = "1220347113@qq.com";
    //发件人账户名
    public static String senderAccount = "1220347113@qq.com";
    //发件人账户密码
    public static String senderPassword = "kmwencsteftljacg";

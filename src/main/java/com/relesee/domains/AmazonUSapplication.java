...
public class AmazonUSapplication {
    private String id;
    private String amazonMail;
    ...
    public String getAmazonMail() {
        return amazonMail;
    }

    public void setAmazonMail(String amazonMail) {
        this.amazonMail = amazonMail;
    }

...
layui.define("layer", function (e) {
    ...
    p.prototype.config = {
        ...
        var e = this,
            ...
            a = i(['<form target="' + f + '" class="' + c + ' hanlinModifyTheUpload" method="post" key="set-mine" enctype="multipart/form-data" action="' + t.url + '">', "</form>"].join(""));
            ...
            u = function () {
                ...
                layui.each(a, function (e, a) {
                    ...
                    r.append(l.field, a), layui.each(l.data, function (e, i) {
                        ...
                        xhr:l.xhr(function(ee){//新增
                        	var percent = Math.floor((ee.loaded / ee.total)*100);//计算百分比
